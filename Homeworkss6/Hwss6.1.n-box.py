...
def print_map(size_x, size_y, pusher_x, pusher_y, boxes, dest_x, dest_y):
    for y in range(size_y):
        for x in range(size_x):
            if x == pusher_x and y == pusher_y:
                ...
                print(" B ", end = "")
            elif x == dest_x and y == dest_y:
                print(" D ", end = "")
            else:
                print(" - ", end = "")
        print()

print_map(size_x, size_y, pusher_x, pusher_y, boxes, dest_x, dest_y)
